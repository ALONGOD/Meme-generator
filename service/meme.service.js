...
const randomMemes = [{ selectedImgId: 1, selectedLineIdx: 0, lines: [{ txt: 'when you get a CR', x: 150, y: 50, size: 30, color: 'white' }] },
{ selectedImgId: 2, selectedLineIdx: 0, lines: [{ txt: 'me and your mum ❤️', x: 200, y: 50, size: 30, color: 'black' }] },
{ selectedImgId: 3, selectedLineIdx: 0, lines: [{ txt: 'when you finally finish the sprint', x: 200, y: 300, size: 20, color: 'black' }] },
...
{ selectedImgId: 6, selectedLineIdx: 0, lines: [{ txt: 'me trying to explain what i do as a junior', x: 200, y: 50, size: 20, color: 'pink' }] },
{ selectedImgId: 13, selectedLineIdx: 0, lines: [{ txt: 'when you get that junior position', x: 200, y: 50, size: 20, color: 'white' }] },
